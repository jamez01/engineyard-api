...
stub_request(:get, "https://cloud.engineyard.com/api/v2/accounts").
  with(:headers => {'X-Ey-Cloud-Token'=>'15cf04980b597ebb1dad5ce0aa717658'}).
  to_return(:status => 200, :body => '{"accounts":[{"id":7952,"name":"James-test"}]}', :headers => {})
...
ey = EngineyardAPI.new(:key => '15cf04980b597ebb1dad5ce0aa717658')
